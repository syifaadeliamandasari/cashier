...
<body id="body-pd">
        ...
        <nav class="nav">
            <div>
                ...
                <div class="nav_list">
                    ...
                    <a href="{{ route('userspetugas') }}" class="nav_link active">
    ...
    <div id="editUserModal" class="modal fade" style="width: 100%;">
    ...
    <div id="addNewModal" class="modal fade" style="width: 100%;">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
