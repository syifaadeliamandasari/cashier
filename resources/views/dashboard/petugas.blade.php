...
<head>
  ...
  <style>
    ...
    table, th, td {
      border: none; /* Menghapus border pada tabel, header, dan sel */
    }
    th, td {
      padding: 8px; /* Menambahkan padding agar teks tidak terlalu dekat dengan tepi */
    }
    th {
      background-color: #f4f4f4; /* Menambahkan latar belakang untuk header tabel */
      font-weight: bold; /* Membuat teks header tabel lebih tebal */
    }
    .text-container {
      margin-bottom: 20px;
    }
        ...
        <nav class="nav">
            <div>
                <a href="#" class="nav_logo">
                    <img src="{{ asset('assets/fashion.png') }}" alt="Logo" class="nav_logo-img">
